...
const HelloWorld = () => (
  <div className="pt-8 text-darkLiver container mx-auto max-w-3xl pb-32 px-4 break-words">
    ...
    <p className="py-4">
      Now, we need Webpack, our handy-dandy
      {' '}
      <span className="italic">static module-bundler</span>
      .
    ...
    <p className="py-4">
      It's a good idea to use ESLint on your javascript projects. It'll help maintain code quality and consistency across your project, and it's also a great learning tool--
      the ESLint warnings and errors provide insight into best practices that you might not know about!
    </p>
    <p className="py-4">
      First, let's install the loader for Webpack:
    </p>
    <code className="py-4 bg-darkLiver text-ecru p-4 rounded block">
    ...
    <p className="py-4">
      Then we'll install peer dependencies (including ESLint itelf), and the base ESLint config from AirBnB, the industry standard:
    </p>
    <code className="py-4 bg-darkLiver text-ecru p-4 rounded block">
      npx install-peerdeps --dev eslint-config-airbnb
    </code>
    <p className="py-4">
      Finally, let's add a couple of sensible defaults to our
      &nbsp;
      <code className="bg-ecru">
        .eslintrc
      </code>
      ;
      these are defining the browser as our global scope, and allowing
      &nbsp;
      <code className="bg-ecru">
        .js
      </code>
    ...
    <p className="py-4">
      If all has gone according to plan, Webpack should boot up your dev server at
      &nbsp;
      <code className="bg-ecru">
        http://localhost:8080
      </code>
    ...
    <div className="bg-white my-4 mx-auto max-w-sm shadow-lg rounded-lg overflow-hidden">
      <div className="sm:flex sm:items-center px-6 py-4">
        ...
        <div className="text-center sm:text-left sm:flex-grow">
          ...
          <div>
            <button type="button" className="text-xs font-semibold rounded-full px-4 py-1 leading-normal bg-white border border-purple-700 text-purple-700 hover:bg-purple-700 hover:text-white">Message</button>
          </div>
        </div>
      </div>
    </div>
    ...
    <p className="py-4">
      ...
      <span role="img" aria-label="winking-cat-face"> 😸</span>
      :
    </p>
    <div className="bg-white p-8 container text-center my-8 mx-auto max-w-lg shadow-lg rounded-lg overflow-hidden">
      ...
      <img alt="yawning cat" className="w-60 h-60 object-cover mx-auto rounded-full" src="https://cdn.pixabay.com/photo/2014/05/07/06/44/cat-339400_1280.jpg" />
